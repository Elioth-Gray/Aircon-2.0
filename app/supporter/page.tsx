      ...
      <div className="mx-10 mt-5 lg:mx-28">
        ...
        <div className="mt-8 relative overflow-hidden lg:py-12 flex flex-row justify-center items-center py-5 bg-[#0A3981] rounded-xl font-winter">
          <Image
            ...
            height={90}
            alt="supporter"
            className="absolute top-2 left-1 lg:hidden"
          ></Image>
          <Image
            src="/supporter1.svg"
            width={300}
            height={300}
            alt="supporter"
            className="hidden top-2 left-20 lg:absolute lg:block"
          ></Image>
          <h1 className="uppercase text-2xl w-full text-white z-10 lg:hidden text-center">
            Supporter
          </h1>
          <h1 className="uppercase w-full hidden lg:block  text-white z-10 text-center text-4xl">
            Support Your Team
          </h1>
          <Image
            src="/supporter2.svg"
            ...
            height={90}
            alt="supporter"
            className="absolute top-2 left-60 lg:hidden"
          ></Image>
          <Image
            src="/supporter2.svg"
            width={300}
            height={90}
            alt="supporter"
            className="hidden top-2 right-20 lg:absolute lg:block"
          ></Image>
        </div>
