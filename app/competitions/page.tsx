      ...
      <div className="px-10 mt-5">
        ...
        <div className="w-full mt-5 flex flex-col gap-3">
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#1F519A] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/KTI.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
                <h1 className="font-bold text-2xl w-3/4 text-wrap">Karya Tulis Ilmiah</h1>
                <div>
            ...
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#1F519A] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/Infografis.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
            ...
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#1F519A] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/Tryout.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
            ...
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#0A3981] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/ML.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
                <h1 className="font-bold text-2xl w-3/4 text-wrap">Mobile Legends</h1>
                <div>
                    <p>Biaya Pendaftaran:</p>
                    <p>Rp35.000,00 per Orang</p>
                </div>
            ...
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#0A3981] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/Businessplan.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
                <h1 className="font-bold text-2xl w-3/4 text-wrap">Business Plan</h1>
                <div>
                    <p>Biaya Pendaftaran:</p>
                    <p>Rp35.000,00 per Orang</p>
                </div>
            ...
            <div className="flex flex-col justify-between items-start text-start gap-3 bg-[#0A3981] p-6 px-8  text-white rounded-xl relative overflow-hidden w-full h-60">
                ...
                <Image src="/Cerdascermat.svg" width={200} height={200} alt="KTI" className="absolute bottom-28 left-56"></Image>
