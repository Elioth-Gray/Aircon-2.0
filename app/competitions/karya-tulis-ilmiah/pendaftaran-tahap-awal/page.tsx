              ...
              <form action="" className="flex flex-col gap-8" onSubmit={handleSubmit(onSubmit)}>
                <div className="w-full flex flex-row justify-between gap-2">
                  <div className="flex flex-col w-1/2 gap-1">
                    ...
                    />
                    {errors.namaTim && (
                      <p className="text-red-500 text-sm">{errors.namaTim.message}</p>
                    )}
                  </div>
                  <div className="flex flex-col w-1/2 gap-1">
                    ...
                    />
                    {errors.asalSekolah && (
                      <p className="text-red-500 text-sm">{errors.asalSekolah.message}</p>
                    )}
                  </div>
                </div>
                <div className="w-full flex flex-row justify-between gap-2">
                ...
                <div className="w-full flex flex-row justify-between gap-2">
                  <div className="flex flex-col w-full gap-1">
                    <label htmlFor="anggota1">Nama Lengkap Anggota 1 (Ketua)*</label>
                    <input
                      type="text"
                    ...
                    />
                    {errors.anggota1 && (
                      <p className="text-red-500 text-sm">{errors.anggota1.message}</p>
                    )}
                  </div>
                </div>
                <div className="w-full flex flex-row justify-between gap-2">
                  <div className="flex flex-col w-full gap-1">
                    ...
                    />
                    {errors.anggota2 && (
                      <p className="text-red-500 text-sm">{errors.anggota2.message}</p>
                    )}
                  </div>
                </div>
                <div className="w-full flex flex-row justify-between gap-2">
                  <div className="flex flex-col w-full gap-1">
                    ...
                    />
                    {errors.anggota3 && (
                      <p className="text-red-500 text-sm">{errors.anggota3.message}</p>
                    )}
                  </div>
                </div>
                {/* <div className="w-full flex flex-row justify-between gap-2">
